...
def test_coordinate_parsing_and_closure():
...
def test_derived_closure_is_explicit():
...
def test_bounds_and_centroid():
    coordinates = [
        Coordinate(100, 45), Coordinate(102, 45), Coordinate(102, 47), Coordinate(100, 47), Coordinate(100, 45)
    ]
...
def test_invalid_coordinates_are_rejected(text: str):
    with pytest.raises(ValueError):
        parse_coordinate_text(text)


def test_tile_estimate_is_positive_and_conservative():
